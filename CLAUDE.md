# fluidd-timelapse: instructions for AI assistants
...
This repo is a solo Bespok3d plugin repo: it ships one plugin, `timelapse`, which enables the
Timelapse menu in Fluidd and Mainsail. It publishes a single index atom into
`Bespok3d/main-index/atoms/`. The plugin ships config, patches, assets, and shell only, no Python.
