...
[![release](https://img.shields.io/github/v/release/Bespok3d/fluidd-timelapse)](https://github.com/Bespok3d/fluidd-timelapse/releases)
[![version](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2FBespok3d%2Ffluidd-timelapse%2Fmain%2Ftimelapse%2Fmanifest.json&query=%24.version&label=version&color=blue)](timelapse/manifest.json)
...
npx b3-builder build --source ./timelapse --atom-repo Bespok3d/fluidd-timelapse
# -> dist/timelapse-<ver>.b3 + dist/timelapse.atom.json
```

## Releasing

Bump `timelapse/manifest.json` `version` and push to `main`. CI runs the `Bespok3d/b3-builder`
